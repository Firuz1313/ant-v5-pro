...
test.describe('Step Form Focus and Scroll Behavior', () => {
  ...
  test('should maintain input focus during continuous typing', async ({ page }) => {
    // Open create dialog
  ...
  test('should preserve focus in textarea fields', async ({ page }) => {
    ...
    const descriptionText = 'This is a long description that spans multiple lines and contains various words';
    ...
    const instructionText = 'These are detailed instructions with multiple sentences. Each sentence contains several words.';
  ...
  test('should handle device selection without affecting input focus', async ({ page }) => {
    // Open create dialog
    await page.click('text=Создать новый шаг');
    await page.waitForSelector('[role="dialog"]');
    ...
    await expect(titleInput).toBeFocused();
    await expect(titleInput).toHaveValue('Initial title text continued after device change');
  });

  test('should handle special characters without focus loss', async ({ page }) => {
    // Open create dialog
    await page.click('text=Создать новый шаг');
    await page.waitForSelector('[role="dialog"]');
  ...
  test('should handle form validation without breaking focus', async ({ page }) => {
    // Open create dialog
    await page.click('text=Создать новый шаг');
    await page.waitForSelector('[role="dialog"]');
