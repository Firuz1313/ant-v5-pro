...
function generateTestImageBase64(targetSizeKB) {
  ...
  const baseData = '';
...
function createTVInterface(data) {
  return new Promise((resolve, reject) => {
    ...
    console.log(`📡 Making POST request with ${Math.round(postData.length / 1024)}KB payload...`);
...
async function testImageSizes() {
  ...
  console.log('🚀 Starting TV Interface creation tests with different image sizes...\n');
