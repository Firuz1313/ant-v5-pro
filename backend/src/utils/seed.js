...
async function seedDatabase() {
  try {
    ...
    `, ['admin-001', 'admin', 'admin@antsupport.com', adminPasswordHash, 'Администратор', 'Системы', 'admin', true]);
    ...
    console.log("🔧 Создание диагностическ��х шагов...");
    ...
    const steps = [
      ...
      },
      {
        ...
        instruction: 'Нажмите кнопку "MENU" на пульте, найдите раздел "Нас��ройки" → "Поиск каналов" → "Автопоиск"',
        estimated_time: 120,
      ...
      // Шаги для проблемы "Пульт не работает"
      {
        ...
        instruction: 'Замените бата��ейки в пульте дистанционного управления на новые',
        estimated_time: 60,
        action_type: 'check',
