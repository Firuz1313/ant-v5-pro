...
async function seedDatabase() {
  try {
    ...
    `, ['admin-001', 'admin', 'admin@antsupport.com', adminPasswordHash, 'admin', true]);
    ...
    const devices = [
      ...
      },
      {
        ...
        brand: 'ANT',
        model: 'ANT-PR300',
        description: 'Профессиональная модель для ко��мерческого использования',
    ...
    const problems = [
      ...
      },
      {
        ...
        description: 'Не удается подключиться к беспроводной сети или соединение не��табильно',
        category: 'moderate',
        icon: 'Wifi',
        color: 'from-purple-500 to-purple-600',
        priority: 3,
    ...
    const steps = [
      ...
      // Шаги для проблемы "Пульт не работает"
      {
        ...
        estimated_time: 60,
        action_type: 'check',
        hint: 'Используйте батарейки типа AAA или AA в зависимо��ти от модели пульта'
      },
      {
        id: 'step-remote-2',
        problem_id: 'problem-remote-not-working',
